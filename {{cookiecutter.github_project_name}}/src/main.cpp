...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "{{cookiecutter.kernel_name}} " << {{cookiecutter.cpp_macro_prefix}}_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, {{cookiecutter.kernel_name}}
